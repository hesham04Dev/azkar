...
import 'package:new_azkar/rootProvider/ThemeProvider.dart';
...
ThemeData buildTheme(BuildContext context,Color accentColor, bool isDark) {
  ...
  final swatch = ColorScheme.fromSwatch(
      primarySwatch: context.read<ThemeProvider>().AccentColor,
